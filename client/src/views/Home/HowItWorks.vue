<template lang="pug">
v-container.py-5
	h1.love-ya.text-xs-center.text--darken-3.grey--text.font-weight-regular Comment ça marche ?
			...
			steps: [
				{
					id: 0,
					heading:
						"Sélectionnez un panier composé ou faites votre propre panier",
					description:
				...
				},
				{
					...
					description:
						"Envie d'un peu plus de pommes ou de bannanes ? De remplacer des carottes pa des pommes de terre ? Faites-vous plaisir.",
				...
				{
					id: 2,
					heading: "Dites-nous où vous livrer",
					description:
				...
				{
					id: 3,
					heading: "Votre panier est arrivé !",
					description:
